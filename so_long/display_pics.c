...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/17 13:52:06 by ethanlim          #+#    #+#             */
/*   Updated: 2024/07/17 13:53:33 by ethanlim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void	*load_image(t_vars *vars, char *img_path, int *img_width, 
// int *img_height)
// {
// 	void *img;
...
// 	img2 = load_image(&vars, "./textures/bats/bat1.xpm", 
// 	&img2_width, &img2_height);
// 	img3 = load_image(&vars, "./textures/bats/bat2.xpm", 
// 	&img3_width, &img3_height);
// 	img4 = load_image(&vars, "./textures/bats/bat3.xpm", 
// 	&img4_width, &img4_height);
// 	img5 = load_image(&vars, "./textures/bats/bat4.xpm", 
// 	&img5_width, &img5_height);
// 	if (img != NULL)
